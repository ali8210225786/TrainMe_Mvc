...
<div id="popup_form" class="popup_box hide">
	...
	<div id="sform_tr" class="tr signupform">
		...
		<form:form method="POST" action="/TrainMe/tr_register" calss="from"
			...
			<div class="wrap">
				...
				<div class="box">
					...
					<div class="group">
						...
						<form:input path="gympassword" class="input_field"
							type="number"
							placeholder="請輸入健身房驗證碼" required="required" />
						<div class="errorMsg">
			...
			<div class="ask_login">
				<p>
					已有帳號？<span class="span-btn" onclick="login()">點我登入</span>
				</p>
			</div>
		</form:form>
	...
	<div id="lf" class="loginform">
		...
		<div class="ask_signup">
			<div class="ask_area">
				...
				<div class="btn_group">
					<button type="button" class="btn ask_btn" id="registerbtn"
						onclick="register_st()">註冊學員</button>
				</div>
				<p>
					<br>
					<br>您是已有健身房驗證碼的教練嗎？
				...
				<div class="btn_group">
					<button type="button" class="btn ask_btn" id="registerbtn"
						onclick="register_tr()">註冊教練</button>
				</div>
			</div>
		</div>
	</div>
