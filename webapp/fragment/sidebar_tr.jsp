...
<div class="aside">
	<ul id="menu">
        ...
        <li><a href="<c:url value='/trainerCourse/${LoginOK.id}' />"><i class="fas fa-user-circle"></i>學員列表</a></li>
        <li><a href="<c:url value='/TimeOff/${LoginOK.id}' />"><i class="far fa-list-alt"></i></i>課程管理</a></li>
