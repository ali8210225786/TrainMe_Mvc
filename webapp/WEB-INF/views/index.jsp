		...
		<div class="container">
			<div class="row about-container">
				...
				<div class="col-lg-6 content order-lg-1 order-2">
					...
					<p>TraineMe是由一群熱愛運動的團隊共同打造，讓想健身的人透過平台尋找喜歡的教練，根據自己的需求，選擇適合的課程。
						健身教練也能透過平台媒合學員，並且能即時開課，展現自己所學。藉由TraineMe讓學員與教練達到互利共享的雙贏空間。</p>
							...
							<div class="card border-0">
								<div class="card-body text-center">
									<a href="<c:url value='/Contact/' />"
										style="text-decoration: none;"> <i
										class="far fa-user-circle fa-5x mb-3" aria-hidden="true"></i>
