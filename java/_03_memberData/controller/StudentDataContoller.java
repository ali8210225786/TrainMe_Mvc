...
//		StudentBean_H studentBean = new StudentBean_H();
	...
	public String updateStudentData(
		...
		// 將圖片存入資料夾
//		private void write(Part photo,String filename, StudentBean_H sb) {  
			String folderPath = String.format("C:/_TraineMe/workspace/TrainMe_springMVC/src/main/webapp/images/profile_photo/student/%s", id);
