...
@WebServlet("/H_Student_RegisterServletMP_new.do")

public class H_Student_RegisterServletMP_new extends HttpServlet {
...
//						GlobalService.encryptString(password));
					...
					StudentBean_H stdent = new StudentBean_H(name, phone, email, birthday, password, id, sex,  myHash);
					
					// 呼叫StudentService的saveStudent方法
					int n = service.saveStudent_H(stdent);
					if (n == 1) {
//=============================================================================================註冊成功後導入頁面	
	...
	private void errorResponse(HttpServletRequest request, HttpServletResponse response, Map<String, String> errorMsg)
		...
		errorMsg.put("tr_from", "st_signUp");
